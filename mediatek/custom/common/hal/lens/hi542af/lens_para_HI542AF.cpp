...
const NVRAM_LENS_PARA_STRUCT HI542AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 HI542AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &HI542AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pHI542AF_getDefaultData = HI542AF_getDefaultData;
