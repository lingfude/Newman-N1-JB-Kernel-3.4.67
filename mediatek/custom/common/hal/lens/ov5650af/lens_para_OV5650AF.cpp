...
const NVRAM_LENS_PARA_STRUCT OV5650AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 OV5650AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &OV5650AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pOV5650AF_getDefaultData = OV5650AF_getDefaultData;
